...
- The 40/15/15/15/15 split is a defensible starting point, not a measured one. If real-world audits show that, say, `llms.txt` adoption becomes a strong differentiator, the weights should shift. That is why a config file for weights is on the [roadmap](../../ROADMAP.md) for v0.2.
